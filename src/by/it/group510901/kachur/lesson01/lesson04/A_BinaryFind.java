...
public class A_BinaryFind {
    ...
    public int[] findIndex(InputStream stream) throws FileNotFoundException {
        ...
        for (int i = 0; i < k; i++) {
            ...
            int foundIndex = -1;    // пока не нашли, индекс = -1
            ...
            while (left <= right) {
                ...
                if (a[middle] == value) {
                    foundIndex = middle;   // запоминаем индекс
                    break;                  // выходим из цикла
                }
                // если искомое число меньше среднего - ищем в левой половине
                else if (value < a[middle]) {
                    right = middle - 1;
                }
                // если искомое число больше среднего - ищем в правой половине
                else {
                    left = middle + 1;
                }
            }
            ...
            // сохраняем результат:
            // если нашли - прибавляем 1
            // если не нашли - оставляем -1

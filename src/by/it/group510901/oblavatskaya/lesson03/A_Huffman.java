package by.it.group510901.oblavatskaya.lesson03;
...
public class A_Huffman {
    ...
    String encode(InputStream inputStream) throws FileNotFoundException {
        ...
        for (Map.Entry<Character, Integer> curr :count.entrySet()) priorityQueue.add(new LeafNode(curr.getValue(), curr.getKey()));

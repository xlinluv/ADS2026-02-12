...
public class B_Huffman {
    ...
    String decode(InputStream inputStream) throws FileNotFoundException {
        ...
        //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! НАЧАЛО ЗАДАЧИ !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1
        // переходим на следующую строку после чисел
        scanner.nextLine();

        // создаем отображение код -> символ
        ...
        // декодируем, проходя по битам и накапливая код
        ...
        for (char bit : encoded.toCharArray()) {
            ...
            if (codeToChar.containsKey(code)) {
                ...
                currentCode.setLength(0); // сбрасываем накопленный код
            }
        }

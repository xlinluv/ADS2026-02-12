...
// Тесты для всех трех задач с расстоянием Левенштейна.
public class Lesson07Test {

    // Проверяет рекурсивную реализацию расстояния Левенштейна.
    @Test
    ...
    // Проверяет итерационную реализацию расстояния Левенштейна.
    @Test
    ...
    // Проверяет восстановление редакционного предписания.
    @Test

...
public class C_LongNotUpSubSeq {
    ...
    int getNotUpSeqSize(InputStream stream) throws FileNotFoundException {
        ...
        // dp[i] - длина наибольшей невозрастающей подпоследовательности, заканчивающейся на m[i]
        int[] dp = new int[n];
        ...
        for (int i = 0; i < n; i++) {
            ...
            prev[i] = -1;
            for (int j = 0; j < i; j++) {
                // Условие для невозрастающей последовательности:
                // предыдущий элемент должен быть больше или равен текущему

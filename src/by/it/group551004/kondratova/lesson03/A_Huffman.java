...
//        c: 110
//        d: 111
//        01001100100111 1 Подсчитываем частоту каждого символа в строке
//2 Создаём листья дерева для каждого символа (вес = частота)
//3 Строим дерево: берём два узла с наименьшей частотой, объединяем в родителя (сумма частот)
//4 Повторяем, пока не останется один корень
//5 Обходим дерево: левый ребёнок = '0', правый = '1'
//6 Кодируем строку, заменяя символы их кодами
...
public class A_Huffman {
    ...
    String encode(InputStream inputStream) throws FileNotFoundException {
        ...
        //5. построим закодированную строку
        for (char c : s.toCharArray()) {

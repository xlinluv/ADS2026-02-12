package by.it.group551004.frantskevich.lesson03;
...
public class A_Huffman {
    ...
    abstract class Node implements Comparable<Node> {
        ...
        private Node(int frequence, char minChar) {
        ...
        public int compareTo(Node o) {
            int cmp = Integer.compare(frequence, o.frequence);
            if (cmp != 0) {
                return cmp;
            }
            return Character.compare(minChar, o.minChar);
        }
    }
    ...
    private class InternalNode extends Node {
        ...
        InternalNode(Node left, Node right) {
            super(left.frequence + right.frequence, (char) Math.min(left.minChar, right.minChar));
            this.left = left;
            this.right = right;
        }

package by.it.group551004.youssef.lesson02;
...
public class Lesson02Test {
    ...
    */
    ...
    public void checkB_sheduler() {
        ...
        List<by.it.group551004.youssef.lesson02.B_Sheduler.Event> starts = instance.calcStartTimes(events, 0, 10);  //рассчитаем оптимальное заполнение аудитории
    ...
    public void checkC_greedyKnapsack() throws Exception {
        InputStream inputStream = by.it.group551004.youssef.lesson02.C_GreedyKnapsack.class.getResourceAsStream("greedyKnapsack.txt");
        double costFinal = new by.it.group551004.youssef.lesson02.C_GreedyKnapsack().calc(inputStream);

...
public class B_Sheduler {
    ...
    List<Event> calcStartTimes(Event[] events, int from, int to) {
        ...
        //фильтруем события, которые попадают в заданный интервал
        ...
        //чем раньше заканчивается событие, тем больше места остается для других

package by.it.group551002.kubarko.lesson03;
...
public class C_HeapMax {
    ...
    private class MaxHeap {
        ...
        int siftDown(int i) { //просеивание вниз
            int maxIndex = i;
            int l = i*2+1;
            if (l < heap.size() && heap.get(l) > heap.get(maxIndex)) maxIndex = l;
            int r = i*2+2;
            if (r < heap.size() && heap.get(r) > heap.get(maxIndex)) maxIndex = r;

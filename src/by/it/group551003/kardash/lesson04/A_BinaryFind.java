...
public class A_BinaryFind {
    ...
    public int[] findIndex(InputStream stream) throws FileNotFoundException {
        ...
        for (int i = 0; i < k; i++) {
            ...
            while (left <= right) {
                int mid = left + (right - left) / 2; // Предотвращение переполнения, хотя при n=100k это не критично
            ...
            // Если элемент найден, преобразуем индекс из 0-based (Java) в 1-based (Условие)
            if (foundIndex != -1) {

package by.it.group551003.yurkevich.lesson03;
...
public class A_Huffman {
    ...
    String encode(InputStream inputStream) throws FileNotFoundException {
        ...
        // Если строка состоит из одного символа, нужно создать корень с одним листом
        if (priorityQueue.size() == 1) {
            priorityQueue.add(new InternalNode(priorityQueue.poll(), null));
        }

...
public class A_QSort {
    ...
    int[] getAccessory(InputStream stream) throws FileNotFoundException {
        ...
        for (int i = 0; i < n; i++) {
            ...
            stopPoints[i] = segments[i].stop;
        }
        quickSort(startPoints, 0, n - 1);
        quickSort(stopPoints, 0, n - 1);

        for (int i = 0; i < m; i++) {
            int leftCount = countLessOrEqual(startPoints, points[i]);
            int rightCount = countLess(stopPoints, points[i]);

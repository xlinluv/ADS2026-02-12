...
public class C_QSortOptimized {
    ...
    private void quickSort(by.it.group551003.khlebnikova.lesson05.C_QSortOptimized.Segment[] segments, int left, int right) {
        while (left < right) {
            ...
            by.it.group551003.khlebnikova.lesson05.C_QSortOptimized.Segment pivot = segments[left];
    ...
    private void swap(by.it.group551003.khlebnikova.lesson05.C_QSortOptimized.Segment[] arr, int i, int j) {
        by.it.group551003.khlebnikova.lesson05.C_QSortOptimized.Segment tmp = arr[i];
        arr[i] = arr[j];
        arr[j] = tmp;
    }
    ...
    private class Segment implements Comparable {
        ...
        public int compareTo(Object o) {
            by.it.group551003.khlebnikova.lesson05.C_QSortOptimized.Segment other = (by.it.group551003.khlebnikova.lesson05.C_QSortOptimized.Segment) o;  // явное приведение типа

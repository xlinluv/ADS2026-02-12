...
public class A_Huffman {
    ...
    String encode(InputStream inputStream) throws FileNotFoundException {
        ...
        for (Map.Entry<Character, Integer> eachLetter: count.entrySet())
            priorityQueue.offer(new LeafNode(eachLetter.getValue(), eachLetter.getKey()));
        ...
        while (priorityQueue.size() > 1) {
            ...
            InternalNode interLeaf = new InternalNode(leaf1, leaf2);

            priorityQueue.offer(interLeaf);
        }

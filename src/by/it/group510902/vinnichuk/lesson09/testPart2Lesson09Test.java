...
public class testPart2Lesson09Test extends HomeWork {
    ...
    public void testTaskA() throws Exception {
        String[] methods = "toString() add(Object) remove(int) size() remove(Object) add(int,Object) remove(Object) set(int,Object) isEmpty() clear() indexOf(Object) get(int) contains(Object) lastIndexOf(Object)".split("\\s+");
    ...
    public void testTaskC() throws Exception {
        String[] methods = "toString() add(Object) remove(int) size() remove(Object) add(int,Object) remove(Object) set(int,Object) isEmpty() clear() indexOf(Object) get(int) contains(Object) lastIndexOf(Object) containsAll(Collection) addAll(Collection) addAll(int,Collection) removeAll(Collection) retainAll(Collection) retainAll(Collection)".split("\\s+");

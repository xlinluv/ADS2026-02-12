...
public class Lesson07Test {
    ...
    public void A() throws Exception {
        ...
        assertEquals("A1 failed", instance.levenstein("ab","ab"),0);
        assertEquals("A2 failed", instance.levenstein("short","ports"),3);
        assertEquals("A3 failed", instance.levenstein("distance","editing"),5);
    }

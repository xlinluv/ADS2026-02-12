...
public class FiboA {
    ...
    public static void main(String[] args) {
        by.it.group510902.derebchinskii.lesson01.FiboA fibo = new by.it.group510902.derebchinskii.lesson01.FiboA();
        int n = 33;
        System.out.printf("calc(%d)=%d \n\t time=%d \n\n", n, fibo.calc(n), fibo.time());

        // вычисление чисел фибоначчи медленным методом (рекурсией)
        fibo = new by.it.group510902.derebchinskii.lesson01.FiboA();
        n = 34;

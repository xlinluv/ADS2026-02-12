package by.it.group510902.derebchinskii.lesson03;
...
public class A_Huffman {
    ...
    String encode(InputStream inputStream) throws FileNotFoundException {
        ...
        while (priorityQueue.size() > 1) {
            ...
            Node left = priorityQueue.poll();  // вытащили первый (самый редкий)
            Node right = priorityQueue.poll(); // вытащили второй

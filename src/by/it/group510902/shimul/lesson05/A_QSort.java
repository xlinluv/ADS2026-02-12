...
public class A_QSort {
    ...
    int[] getAccessory(InputStream stream) throws FileNotFoundException {
        ...
        // 2. Создаём массивы starts и ends
        ...
        // ends тоже нужно отсортировать
        Arrays.sort(ends);

        // 3. Для каждой точки считаем ответ бинарными поисками
        for (int i = 0; i < m; i++) {
            int p = points[i];

            int started = upperBound(starts, p); // start ≤ p
            int ended = lowerBound(ends, p);     // end < p
